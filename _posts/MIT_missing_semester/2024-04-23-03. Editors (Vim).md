---
title: 03. Editors (Vim)
description: A comprehensive guide to using Vim as an efficient text editor for programming and writing.
categories: [Course Notes, MIT Missing Semester]
tags: [vim, text-editor, programming, productivity]
math: true
---
<iframe width="560" height="315" src="https://www.youtube.com/embed/a6Q8Na575qc?si=rnQOuzT7KUarr2ox" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
