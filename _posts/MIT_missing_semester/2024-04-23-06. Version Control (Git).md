---
title: 06. Version Control (Git)
description: A comprehensive guide to using Git for version control and collaboration.
categories: [Course Notes, MIT Missing Semester]
tags: [git, version-control, collaboration, programming, productivity]
---
<iframe width="560" height="315" src="https://www.youtube.com/embed/2sjqTHE0zok?si=bbgXG8emptDw3cCl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
